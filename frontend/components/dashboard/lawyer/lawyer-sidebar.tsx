...
import { Scale, LayoutDashboard, Briefcase, Calendar, User, Bell, LogOut, Menu, X } from "lucide-react"
...
export function LawyerSidebar({ activeTab, setActiveTab, sidebarOpen, setSidebarOpen }: LawyerSidebarProps) {
